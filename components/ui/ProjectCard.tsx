...
export default function ProjectCard({ project, index }: ProjectCardProps) {
  return (
    <motion.article
      ...
      className="group relative flex flex-col overflow-hidden rounded border border-white/10 bg-white/[0.045] p-6 shadow-2xl shadow-black/25 transition duration-300 hover:-translate-y-[6px] hover:border-cyan/70 hover:shadow-[0_0_20px_rgba(0,212,255,0.15)]"
    >
      ...
      <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-400 transition group-hover:text-slate-200">
